...
### 1.3.2：2026.4.19
- 修复了我也不知道是啥的，乱乱的bug。总之就是，现在可以正常使用了。
- 更改了配置判断逻辑，现在为true时是启用。具体看设置的时候应该就可以看懂了。

	<span style="color:#999;">为什么更改？【因为我自己回看代码，自己都快看不懂了】😂</span>
